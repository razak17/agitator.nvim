...
local ns_id = vim.api.nvim_create_namespace("agitator_time_machine")
...
local function setup_timemachine_popup(opts)
  ...
  vim.api.nvim_set_option_value("buftype", "nofile", { buf = vim.b.popup_buf })
  vim.api.nvim_set_option_value("modifiable", true, { buf = vim.b.popup_buf })
  vim.api.nvim_set_option_value("filetype", "AgitatorTimeMachine", { buf = vim.b.popup_buf })
  ...
  vim.b.popup_win = vim.api.nvim_open_win(vim.b.popup_buf, false, win_opts)
end
...
local function time_machine_statusline(i, entries_count, record)
  ...
  vim.api.nvim_buf_clear_namespace(vim.b.popup_buf, ns_id, 0, -1)
  vim.api.nvim_buf_set_extmark(vim.b.popup_buf, ns_id, 0, 0, { end_line = 0, hl_group = "Identifier", hl_eol = true })
  vim.api.nvim_buf_set_extmark(vim.b.popup_buf, ns_id, 1, 0, { end_line = 1, hl_group = "PreProc", hl_eol = true })
  vim.api.nvim_buf_set_extmark(vim.b.popup_buf, ns_id, 2, 0, { end_line = 2, hl_group = "Special", hl_eol = true })
  vim.api.nvim_buf_set_extmark(
    vim.b.popup_buf,
    ns_id,
    3,
    0,
    { end_line = 3, hl_group = "SpecialComment", hl_eol = true }
  )
end
...
local function git_time_machine_display()
  ...
  vim.defer_fn(function()
    time_machine_statusline(i, entries_count, record)
  end, 50)
end
